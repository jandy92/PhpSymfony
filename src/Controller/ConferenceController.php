...
class ConferenceController extends AbstractController
{
    ...
    */
    public function show(Request $request, Conference $conference, CommentRepository $commentRepository, NotifierInterface $notifier, string $photoDir, ConferenceRepository $conferenceRepository)
    {
        $comment = new Comment();
